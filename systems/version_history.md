...
| Version | Date | What |
|---------|------|------|
| **0.0.14-wip** | **2026-08-05** | **P10 for-in loop DONE. P10 generics monomorphization NEXT. P6 stubs moved to P11. P12 = GPU/PTX/SPIR-V/WASM.** ARM64 IR_STR + syscall parity fixed (0d08086b). Cross-compiles to ARM64; native ARM64 self-host segfaults on real hardware (known_warts_bugs.md §10.2). |
| **0.0.13** | **2026-08-02** | **P9 traits/impl/vtable dispatch/struct literals STABLE.** trait_test passes, self-host fixed-point, ARM device verified (7421bbb gsz fix). |
...
| **0.0.10** | **2026-07-31** | **Batch 2 P6: FFI calls + SIMD/asm stubs; both backends 38/38 (91d7053).** |
...
| 1.1.8 | 2026-07-22 | P2 ownership: compiler-inserted free |
...
## Pillar Mapping (Corrected 2026-08-05)

| Pillar | Feature | Version Range | Status |
|--------|---------|---------------|--------|
| **P1** | Types, fn, control flow, arrays | 0.0.1 | ✅ DONE |
| **P2** | Memory/ownership (mmap, free, globals) | 0.0.1 | ✅ DONE |
| **P3** | FFI / C ABI / fnptr | 0.0.8–0.0.10 | ✅ DONE |
| **P4** | Multi-backend (x86 + ARM64) | 0.0.7 | ✅ DONE |
| **P5** | ELF writer, BSS, static PIE | 0.0.13 (gsz fix) | ✅ DONE |
| **P6** | **Raw ptr deref/arith/cast/null + `unsafe {}`** | 0.0.8–0.0.10 | ✅ **CLOSED** |
| **P7** | Option/Result/Enum/Match/unwrap | 0.0.11 | ✅ DONE |
