...
- **Native AOT compilation (`qc`)** — **ACTIVE, 0.0.117**. x86-64 only
  ...
  `qc` (verified fixed point md5 `8b8a1e21573f12b5742a64f695a50b85`).
  Full gate (all 10 layers GREEN): functional **152/152** (+ extern-c,
