...
- **Native AOT compilation (`qc`)** — **ACTIVE, 0.0.116**. x86-64 only
  ...
  `qc` (verified fixed point md5 `662de43a69d848581774e81f01703456`).
  Full gate (all 10 layers GREEN): functional **151/151** (+ extern-c,
