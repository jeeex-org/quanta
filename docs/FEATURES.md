...
|| `quantum` (QFT/Grover/Shor/VQE/QAOA, error correction, PQC migration, QKD) | ❌ todo → **0.0.183–0.0.186 core** | ❌ none | Quantum algorithms (QFT/Grover/Shor/VQE/QAOA), error correction (surface/color/stabilizer), PQC migration/CNSA 2.0/HPKE, QKD/quantum internet. |
