...
| `$$(cmd)` external command | ✅ done (0.0.74) | 🟡 1 test | string form `$$("echo hi")`, array form `$$(["/bin/echo","hi"])`, and identifier shorthand `$$(ls)` == `$$("ls")`. Returns CmdResult{out, code, err}. Gated behind `unsafe {}` |
