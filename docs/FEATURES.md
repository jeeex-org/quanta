...
| `secure_ext` (TLS resumption, mTLS, HSM, hardening) | ❌ todo → **0.154–0.158 core** | ❌ none | Session tickets/PSK/0-RTT, mTLS/SPIFFE, TPM/PKCS#11/SGX, key derivation (PBKDF2/Argon2/Scrypt), encrypted keystore, constant-time comparators, masking/blinding, formal verification hooks, audit logging, supply chain (sigstore), compliance (FIPS 140-3/CC). |
