...
## RECOMMENDED FILE STRUCTURE (concern-oriented; backends split per TARGET)
  ...
  `compiler/0.0.68/src/x86/` (main.quanta + helpers/lexer/parse/codegen/
...
Each stage gates on: recompile + 2-stage self-host (byte-identical fixed point) + 105/105 tests
